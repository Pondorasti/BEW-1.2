...
class MainTests(unittest.TestCase):
    ...
    def test_book_detail_logged_out(self):
        ...
        res = self.app.get("/book/1")
        self.assertEqual(res.status_code, 200)

        res_text = res.get_data(as_text=True)
        self.assertIn("To Kill a Mockingbird", res_text)
        self.assertIn("Harper Lee", res_text)
        self.assertIn("July 11, 1960", res_text)

        self.assertNotIn("Favorite", res_text)
    ...
    def test_book_detail_logged_in(self):
        ...
        self.assertIn("Favorite", res_text)
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name="hello").one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.biography, "world")
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name="pop").one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, "pop")

    def test_profile_page(self):
        create_user()

        res = self.app.get("/profile/me1")
        self.assertEqual(res.status_code, 200)

        res_text = res.get_data(as_text=True)
        self.assertIn("Welcome to me1's profile.", res_text)
